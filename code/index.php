        ...
        <div class="haticons-set">
            <?php
                $haticons = array(
                    ...
                    array(
                        'class' => 'hi-user-minus1',
                        'content' => "\\f0f0"
                    ),
                    array(
                        'class' => 'hi-user-check1',
                        'content' => "\\f0f1"
                    ),
                    array(
                        'class' => 'hi-users11',
                    ...
                    array(
                        'class' => 'hi-micro-dot-blog',
                        'content' => "\\eb7a"
                    ),
                    array(
                        'class' => 'hi-microgenetics1',
                        'content' => "\\eb7b"
                    ),
                    array(
                        'class' => 'hi-microsoft1',
